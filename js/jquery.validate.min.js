...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            remote: "Porfavor repara este campo",
            email: "Porfavor ingresa una direccion E-mail valida",
            url: "Porfavor ingresa una URL valida",
            date: "Porfavor ingresa una fecha valida",
            dateISO: "Please enter a valid date (ISO)",
            number: "Porfavor ingresa un numero valido",
            digits: "Porfavor ingresa solo digitos",
            creditcard: "Porfavor ingresa una tarjeta de credito valda",
            equalTo: "Porfavor ingresa el mismo valor otra vez",
            maxlength: $.validator.format("Porfavor ingresa no mas que {0} caracteres"),
            minlength: $.validator.format("Porfavor ingresa al menos {0} caracteres"),
            rangelength: $.validator.format("Porfavor ingresa un valor entre {0} y {1} caracteres maximo"),
            range: $.validator.format("Porfavor ingresa un valor entre {0} y {1}"),
            max: $.validator.format("Porfavor ingresa un valor menor que o igual a {0}"),
            min: $.validator.format("Porfavor ingresa un valor mayor que o igual a {0}")
        },
